...
class k8ldCurl {
    ...
    **/
     ...
     * @return k8ldCurlResponse object
    **/
    ...
    **/
     ...
     *
     * Returns a k8ldCurlResponse object if the request was successful, false otherwise
     *
     * @param string $url
     * @param array|string $vars 
     * @return k8ldCurlResponse
    **/
    ...
    **/
     ...
     * @param string $url
     * @param array|string $vars 
     * @return k8ldCurlResponse|boolean
    **/
    ...
    **/
    function request($method, $url, $vars = array()) {
        ...
        if ($response) {
            $response = new k8ldCurlResponse($response);
        } else {
